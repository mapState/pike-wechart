<template>
  <div class="container" @click="setFalse">
    ...
    <div class="half" style="padding-bottom:30px;">
      <div class="pkList" v-for="(item,i) in pkList" :key="i">
        <div class="item">
        ...
        <div class="itemTxt">
          <div class="leftTxt">
            <img :src="item.aImgUrl" alt mode="widthFix" @click="toUser(item.aUserId)" />
          ...
          <div class="rightTxt">
            <img :src="item.bImgUrl" alt mode="widthFix" @click="toUser(item.bUserId)" />
...
export default {
  ...
  methods: {
    ...
    textIn(t) {
      ...
      this.pageSize = 10;
      this.pkList = [];
      this.getPkList(this.tag, this.$mp.query.matchStatus, this.msg);
    ...
    getPkList(videoTag, type, keyword) {
      common
        .pkList({
          videoTag,
          pageNo: this.page,
